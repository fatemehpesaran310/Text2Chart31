...
sft_model_id = "./checkpoint/cp-task3-lora32-epoch5-llama3-fast/final/"
sft_model: LoraModel = PeftModel.from_pretrained(
    model, sft_model_id, offload_folder="lora_results/lora_7/temp"
)
sft_model = sft_model.merge_and_unload()


rl_model_id = "policy3-joint-bert-v3-2k-random-data-step63"
